...
from google3.third_party.google_research.google_research.graphqa import name_dictionaries
...
def create_node_string(name_dict: dict[int, str], nnodes: int) -> str:
  node_string = ""
...
def with_ids(graph: nx.Graph, text_encoder: str) -> nx.Graph:
  nx.set_node_attributes(graph, TEXT_ENCODER_DICT[text_encoder], name="id")
  return graph


def encode_graph(graph: nx.Graph, text_encoder: str) -> str:
